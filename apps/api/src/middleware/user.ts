 ...
 * auto-registers it in the Registry, and exposes `identity` and `registry` on the context.
 * The per-user DO stub (`c.var.user`) will be attached here once the User DO exists.
 */
