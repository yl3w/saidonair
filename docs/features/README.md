...
> This directory preserves the first code-derived feature-document snapshot.
> The [v1 feature documents](v1/README.md) are the current behavior reference.
...
**Executable source code is the authority for this documentation.** The
[PRD](../../docs/PRD.md) supplies product intent and historical context. When it,
an older spec, or a source comment disagrees with the implementation, these
documents describe the implementation and identify the difference. They do not
silently treat a planned feature as built or a discrepancy as a requested fix.
...
- [Design guide](../../docs/design.md) records design intent; feature pages
...
and relevant tests. Update its inspected revision and PRD differences. Related
