...
[PRD §4.1 and §7](../../docs/PRD.md) are the starting points. The current Source
screen implements a capped newest-first list rather than history paged by year.
