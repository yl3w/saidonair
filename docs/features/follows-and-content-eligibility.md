...
[PRD §4.3](../../docs/PRD.md) supplies the product context. Read any older
"followed content starts unread" wording with the receipt-retention rule above.
Likewise, older descriptions of follows being required to read a summary do not
describe today's public direct reads. They apply to personalized operations.
