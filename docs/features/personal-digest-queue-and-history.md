...
[PRD §4.4 and §7](../../docs/PRD.md) still describe a Queue containing all waiting
days and an all-unread ending/count. Current Queue is day-scoped. Current History
heads the list with a date when content exists rather than always displaying a
visible “History” heading. The code behavior described here takes precedence.
